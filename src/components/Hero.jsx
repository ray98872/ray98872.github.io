  ...
  return (
    <section className="pb-12 pt-14 sm:pb-16 sm:pt-20">
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="fade-in mb-5 inline-flex items-center gap-2 rounded-full border border-line bg-cream/[0.04] px-3.5 py-1.5 text-[11px] font-medium uppercase tracking-[0.16em] text-faint transition-colors duration-300 hover:border-copper/40 hover:text-copper-soft"
        style={{ "--d": "150ms" }}
      >
      ...
      <h1 className="max-w-3xl text-[clamp(2.2rem,6vw,4.2rem)] font-semibold leading-[1.04] tracking-[-0.02em] text-cream">
        <span className="line-mask">
          <span style={{ "--d": "250ms" }}>I like AI</span>
        </span>
        <span className="line-mask">
          <span style={{ "--d": "380ms" }}>
            <span className="font-display font-light italic text-copper">I guess</span>
          </span>
        </span>
        <span className="line-mask">
          <span style={{ "--d": "510ms" }}>{"¯\\_(ツ)_/¯"}</span>
        </span>
      </h1>
